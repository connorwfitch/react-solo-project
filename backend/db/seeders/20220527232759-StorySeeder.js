    ...
    return queryInterface.bulkInsert('Stories', [
      {
        ...
        content: 'One of the many benefits of walkable communities is the intrinsic exercise that you get each day. Those little bits of walking or biking around that you do in your day-to-day life such as picking up groceries or meeting a friend for coffee really add up. Further, while you certainly can mitigate the adverse health consequences of the sedentary life that car-dependent infrastructure imposes, doing so is largely facilitated by access to money. In a Stanford study from 2017, researchers found that not only was there a negative correlation between city wakability and obesity, but also that those health benefits were largely felt by those with lower incomes, leading the researchers to use the term "activity inequality" to describe how car-dependency disproportionately impacts those with the least in our society.',
        userId: 1,
      },
      {
        ...
        content: 'Some of the most delightful urban spaces are also some of the smallest, and it is a seemingly-counterintuitive observation that we should more deeply consider. This is true of both public and private space. Think of the most charming, appealing spaces you have ever spent time in: gardens, patios, courtyards, alleyways, or pedestrian streets. The reason behind this is twofold. First is simply that spaces scaled to our physical bodies are more comfortable, providing a sense of enclosure and security. Wide open spaces without defining edges can be ovewhelming and alienating. The other reason has to do with our capacity for attention. When you\'re designing a small space, you are more likely to consider every detail and every inch, but on larger scales this attention to detail becomes unsustainable, leaving us with large, nondescript lawns and oversized superstore parking lots. Not to mention that these smaller places are safer and more likely to be financially solvent! (See other articles for more.)',
        userId: 2,
      },
      {
